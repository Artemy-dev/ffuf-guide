...
> 🛑 **Важно!** DoS-атаки — это незаконные действия, если проводятся без разрешения владельца ресурса. Используй ffuf только в рамках легального пентестинга (bug bounty, CTF, тестовая среда и т.д.).<br>
